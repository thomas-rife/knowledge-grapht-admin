...
const ClassRoster = ({ params }: { params: { className: string } }) => {
  ...
  const itemsPerPage =
    viewMode === "grid" ? STUDENTS_PER_PAGE : LIST_VIEW_ITEMS_PER_PAGE;
      ...
      <Box sx={{ mb: 4 }}>
        <Grid container spacing={3} alignItems="center">
          ...
          >
            ...
            >
              <MenuItem onClick={() => handleSort("student_name")}>
                Name
              </MenuItem>
            </Menu>
            <ToggleButtonGroup
                  ...
                  >
                    <CardContent>
                      ...
                      >
                        ...
                        <Tooltip title="View student knowledge graph">
                          <IconButton
                            onClick={() =>
                              router.push(
                                `/classes/${params.className}/roster/${student.student_id}`,
                              )
                            }
                          >
                            <AccountTree />
            ...
            <Card elevation={1}>
              {displayedStudents.map((student, index) => (
                <Box key={student.student_id}>
                  {index > 0 && (
                    <Box sx={{ mx: 2, borderTop: 1, borderColor: "divider" }} />
                  )}
                  <CardContent>
